...
<!-- Please read https://github.com/linuxserver/docker-orcaslicer-snapmaker/blob/master/.github/CONTRIBUTING.md -->
...
# [linuxserver/orcaslicer-snapmaker](https://github.com/linuxserver/docker-orcaslicer-snapmaker)

[![Scarf.io pulls](https://scarf.sh/installs-badge/linuxserver-ci/linuxserver%2Forcaslicer-snapmaker?color=94398d&label-color=555555&logo-color=ffffff&style=for-the-badge&package-type=docker)](https://scarf.sh)
[![GitHub Stars](https://img.shields.io/github/stars/linuxserver/docker-orcaslicer-snapmaker.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/linuxserver/docker-orcaslicer-snapmaker)
[![GitHub Release](https://img.shields.io/github/release/linuxserver/docker-orcaslicer-snapmaker.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/linuxserver/docker-orcaslicer-snapmaker/releases)
[![GitHub Package Repository](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=GitHub%20Package&logo=github)](https://github.com/linuxserver/docker-orcaslicer-snapmaker/packages)
[![GitLab Container Registry](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=GitLab%20Registry&logo=gitlab)](https://gitlab.com/linuxserver.io/docker-orcaslicer-snapmaker/container_registry)
[![Quay.io](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=Quay.io)](https://quay.io/repository/linuxserver.io/orcaslicer-snapmaker)
[![Docker Pulls](https://img.shields.io/docker/pulls/linuxserver/orcaslicer-snapmaker.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=pulls&logo=docker)](https://hub.docker.com/r/linuxserver/orcaslicer-snapmaker)
[![Docker Stars](https://img.shields.io/docker/stars/linuxserver/orcaslicer-snapmaker.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=stars&logo=docker)](https://hub.docker.com/r/linuxserver/orcaslicer-snapmaker)
[![Jenkins Build](https://img.shields.io/jenkins/build?labelColor=555555&logoColor=ffffff&style=for-the-badge&jobUrl=https%3A%2F%2Fci.linuxserver.io%2Fjob%2FDocker-Pipeline-Builders%2Fjob%2Fdocker-orcaslicer-snapmaker%2Fjob%2Fmaster%2F&logo=jenkins)](https://ci.linuxserver.io/job/Docker-Pipeline-Builders/job/docker-orcaslicer-snapmaker/job/master/)
[![LSIO CI](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=CI&query=CI&url=https%3A%2F%2Fci-tests.linuxserver.io%2Flinuxserver%2Forcaslicer-snapmaker%2Flatest%2Fci-status.yml)](https://ci-tests.linuxserver.io/linuxserver/orcaslicer-snapmaker/latest/index.html)

[Snapmaker Orca](https://github.com/Snapmaker/OrcaSlicer) is an open source slicer for FDM printers based on OrcaSlicer and maintained by Snapmaker.

[![orcaslicer-snapmaker](https://raw.githubusercontent.com/Snapmaker/OrcaSlicer/main/resources/images/Snapmaker_Orca_192px.png)](https://github.com/Snapmaker/OrcaSlicer)

## Supported Architectures

We utilise the docker manifest for multi-platform awareness. More information is available from docker [here](https://distribution.github.io/distribution/spec/manifest-v2-2/#manifest-list) and our announcement [here](https://blog.linuxserver.io/2019/02/21/the-lsio-pipeline-project/).

Simply pulling `lscr.io/linuxserver/orcaslicer-snapmaker:latest` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
---
services:
  orcaslicer-snapmaker:
    image: lscr.io/linuxserver/orcaslicer-snapmaker:latest
    environment:
      - PIXELFLUX_WAYLAND=true
...
docker run -d \
  ...
  --restart unless-stopped \
  lscr.io/linuxserver/orcaslicer-snapmaker:latest
```
...
| Parameter | Function |
| :----: | --- |
| `-p 3000:3000` | Snapmaker Orca desktop gui HTTP, must be proxied. |
| `-p 3001:3001` | Snapmaker Orca desktop gui HTTPS. |
...
[![Docker Mods](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=orcaslicer-snapmaker&query=%24.mods%5B%27orcaslicer-snapmaker%27%5D.mod_count&url=https%3A%2F%2Fraw.githubusercontent.com%2Flinuxserver%2Fdocker-mods%2Fmaster%2Fmod-list.yml)](https://mods.linuxserver.io/?mod=orcaslicer-snapmaker "view available mods for this container.") [![Docker Universal Mods](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=universal&query=%24.mods%5B%27universal%27%5D.mod_count&url=https%3A%2F%2Fraw.githubusercontent.com%2Flinuxserver%2Fdocker-mods%2Fmaster%2Fmod-list.yml)](https://mods.linuxserver.io/?mod=universal "view available universal mods.")
...
* Shell access whilst the container is running:
    ...
    ```bash
    docker exec -it orcaslicer-snapmaker /bin/bash
    ```

* To monitor the logs of the container in realtime:

    ```bash
    docker logs -f orcaslicer-snapmaker
    ```

* Container version number:

    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' orcaslicer-snapmaker
    ```

* Image version number:

    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/orcaslicer-snapmaker:latest
    ```
...
* Update images:
    ...
    * Single image:
        ...
        ```bash
        docker-compose pull orcaslicer-snapmaker
        ```
...
* Update containers:
    ...
    * Single container:
        ...
        ```bash
        docker-compose up -d orcaslicer-snapmaker
        ```
...
* Update the image:
    ...
    ```bash
    docker pull lscr.io/linuxserver/orcaslicer-snapmaker:latest
    ```
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/orcaslicer-snapmaker:latest .
```
